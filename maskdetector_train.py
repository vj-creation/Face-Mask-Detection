...
# take the list of images in our dataset directory, then initialize the list of data and class images
...
# constructing head of the model that will be placed on top of the base model
